...
export const chapter10: Chapter = {
  ...
  lessons: [
    {
      id: 'topic_10_1',
      title: '10.1 Lanterna semaforica veicolare normale',
      italianText: `La lanterna semaforica veicolare normale è il semaforo classico a tre luci e di solito si trova in corrispondenza di un incrocio. Regola il transito di tutti i veicoli, non solo autobus, biciclette o mezzi pubblici.

Con luce verde si può attraversare l'incrocio usando prudenza. Con luce gialla fissa si deve fermarsi se è possibile farlo in sicurezza; se l'incrocio è già impegnato, bisogna liberarlo rapidamente. Con luce rossa è obbligatorio arrestarsi. Se il semaforo è spento, guasto o funziona con luce gialla lampeggiante, si passa solo con molta prudenza e rispettando le precedenze.`,
      farsiTranslation: `چراغ راهنمایی معمولی خودرو همان چراغ سه‌رنگ کلاسیک است و معمولا در تقاطع نصب می‌شود. عبور همه وسایل نقلیه را تنظیم می‌کند، نه فقط اتوبوس، دوچرخه یا وسایل عمومی.

چراغ سبز یعنی می‌توانی با احتیاط وارد تقاطع شوی. زرد ثابت یعنی اگر با ایمنی ممکن است باید توقف کنی؛ اگر وارد تقاطع شده‌ای باید سریع آن را خالی کنی. قرمز یعنی توقف اجباری. اگر چراغ خاموش، خراب یا زرد چشمک‌زن باشد، فقط با احتیاط زیاد و رعایت حق تقدم عبور می‌کنی.`,
      vocabularyIds: [
        'se',
        'solo',
        'luce_gialla_lampeggiante',
        'arrestarsi',
        'veicoli',
        'binari',
        'biciclette',
      ...
      questionIds: Array.from({ length: 9 }, (_, i) => `q_10_1_${i + 1}`)
    },
    {
      id: 'topic_10_2',
      title: '10.2 Luce rossa del semaforo',
      italianText: `La luce rossa è posta in alto nei semafori verticali e a sinistra in quelli orizzontali. Può avere dimensioni più grandi per essere più visibile. Quando è accesa, vieta il passaggio ai veicoli diretti verso quella luce.

Il conducente deve arrestarsi prima della striscia trasversale di arresto, senza impegnare l'incrocio. Non è consentito svoltare, ripartire lentamente o attraversare solo perché l'incrocio sembra libero.`,
      farsiTranslation: `چراغ قرمز در چراغ‌های عمودی بالا قرار دارد و در چراغ‌های افقی سمت چپ است. ممکن است از چراغ‌های دیگر بزرگ‌تر باشد تا بهتر دیده شود. وقتی روشن است، عبور برای وسایلی که به سمت آن چراغ می‌آیند ممنوع است.

راننده باید قبل از خط توقف عرضی بایستد و وارد تقاطع نشود. با چراغ قرمز نمی‌توان پیچید، آرام حرکت کرد یا فقط به خاطر خالی بودن تقاطع عبور کرد.`,
      vocabularyIds: [
        'strada',
        'solo',
        'presenza',
      ...
      questionIds: Array.from({ length: 10 }, (_, i) => `q_10_2_${i + 1}`)
    },
    {
      id: 'topic_10_3',
      title: '10.3 Luce verde del semaforo',
      italianText: `Con luce verde si può impegnare e attraversare l'incrocio, ma sempre con prudenza. È possibile proseguire diritto, svoltare a destra o svoltare a sinistra, rispettando però pedoni e veicoli che hanno precedenza.

Chi svolta a destra deve lasciare passare i pedoni che attraversano. Chi svolta a sinistra deve dare precedenza ai pedoni e ai veicoli provenienti di fronte. Se il verde è acceso da molto tempo, è prudente prepararsi al possibile cambio al giallo.`,
      farsiTranslation: `با چراغ سبز می‌توانی وارد تقاطع شوی و عبور کنی، اما همیشه با احتیاط. می‌توانی مستقیم بروی، به راست بپیچی یا به چپ بپیچی، ولی باید حق تقدم عابران و وسایل دیگر را رعایت کنی.

اگر به راست می‌پیچی باید عابرانی را که عبور می‌کنند رد کنی. اگر به چپ می‌پیچی باید به عابران و خودروهای روبه‌رو حق تقدم بدهی. اگر چراغ سبز مدت زیادی روشن بوده، باید آماده تغییر به زرد باشی.`,
      vocabularyIds: [
        'se',
        'solo',
        'corsie',
      ...
      questionIds: Array.from({ length: 12 }, (_, i) => `q_10_3_${i + 1}`)
    },
    {
      id: 'topic_10_4',
      title: '10.4 Luce gialla fissa del semaforo',
      italianText: `La luce gialla fissa si accende quando si spegne il verde e avvisa che sta per accendersi il rosso. È collocata tra il rosso e il verde.

Se ci si può fermare in sicurezza prima dell'incrocio, bisogna fermarsi. Se invece l'incrocio è già impegnato e fermarsi creerebbe pericolo, bisogna sgomberarlo al più presto. Non significa proseguire sempre, tornare indietro o fermarsi in ogni caso senza valutare la sicurezza.`,
      farsiTranslation: `چراغ زرد ثابت وقتی روشن می‌شود که سبز خاموش شده و قرمز در حال روشن شدن است. جای آن بین قرمز و سبز است.

اگر می‌توانی با ایمنی قبل از تقاطع بایستی، باید توقف کنی. اگر وارد تقاطع شده‌ای و توقف خطر ایجاد می‌کند، باید هرچه زودتر تقاطع را خالی کنی. زرد ثابت یعنی همیشه ادامه بده، عقب برگرد یا در هر شرایطی ناگهانی توقف کن نیست.`,
      vocabularyIds: [
        'se',
        'pericolo',
        'sempre',
      ...
      questionIds: Array.from({ length: 11 }, (_, i) => `q_10_4_${i + 1}`)
    },
    {
      id: 'topic_10_5',
      title: '10.5 Quando il passaggio è consentito',
      italianText: `Con il semaforo a tre luci il passaggio è consentito quando la luce verde è accesa. È consentito anche con giallo fisso solo se non è più possibile fermarsi in sicurezza prima dell'incrocio.

Quando il semaforo è spento, guasto o funziona a luce gialla lampeggiante, si può passare soltanto con massima prudenza e moderando la velocità. Non si passa con rosso acceso solo perché non arrivano veicoli da altre direzioni.`,
      farsiTranslation: `با چراغ سه‌رنگ، عبور وقتی مجاز است که چراغ سبز روشن باشد. با زرد ثابت هم فقط وقتی می‌توانی عبور کنی که دیگر نتوانی با ایمنی قبل از تقاطع توقف کنی.

اگر چراغ خاموش یا خراب است یا زرد چشمک‌زن کار می‌کند، فقط با احتیاط زیاد و سرعت کم می‌توان عبور کرد. با قرمز روشن، حتی اگر از جهت‌های دیگر وسیله‌ای نیاید، عبور مجاز نیست.`,
      vocabularyIds: [
        'se',
        'solo',
        'in_caso_di',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_5_${i + 1}`)
    },
    {
      id: 'topic_10_6',
      title: '10.6 Semafori veicolari di corsia: frecce',
      italianText: `I semafori veicolari di corsia usano frecce luminose e riguardano i veicoli che devono andare nella direzione indicata dalla freccia. La freccia verde consente il passaggio solo nel senso indicato, non in tutte le direzioni.

La freccia rossa impone l'arresto ai veicoli diretti in quel senso. La freccia gialla fissa avvisa di liberare l'incrocio se è già stato impegnato o di fermarsi se è possibile farlo in sicurezza.`,
      farsiTranslation: `چراغ‌های خط عبور با فلش کار می‌کنند و برای وسایلی هستند که می‌خواهند در جهت فلش حرکت کنند. فلش سبز فقط عبور در همان جهت را مجاز می‌کند، نه همه جهت‌ها.

فلش قرمز یعنی وسایلی که به آن جهت می‌روند باید توقف کنند. فلش زرد ثابت یعنی اگر وارد تقاطع شده‌ای آن را خالی کن، و اگر می‌توانی با ایمنی توقف کنی، بایست.`,
      vocabularyIds: [
        'se',
        'solo',
        'corsia',
      ...
      questionIds: Array.from({ length: 6 }, (_, i) => `q_10_6_${i + 1}`)
    },
    {
      id: 'topic_10_7',
      title: '10.7 Semafori veicolari di corsia: uso e limiti',
      italianText: `Questi semafori non sono segnali per tram, treni, ponti mobili o imbarco dei traghetti. Non sono riservati ai mezzi pubblici e non sono semafori per corsie reversibili.

Se funzionano con freccia gialla lampeggiante o sono spenti, si può transitare con particolare prudenza. La regola essenziale è seguire solo la direzione indicata dalla freccia accesa.`,
      farsiTranslation: `این چراغ‌ها برای ترام، قطار، پل متحرک یا محل سوار شدن به کشتی نیستند. مخصوص وسایل عمومی هم نیستند و چراغ مسیرهای برگشت‌پذیر محسوب نمی‌شوند.

اگر با فلش زرد چشمک‌زن کار کنند یا خاموش باشند، فقط با احتیاط زیاد عبور می‌کنی. قانون اصلی این است: فقط جهتی را دنبال کن که فلش روشن نشان می‌دهد.`,
      vocabularyIds: [
        'se',
        'solo',
        'corsie',
      ...
      questionIds: Array.from({ length: 14 }, (_, i) => `q_10_7_${i + 1}`)
    },
    {
      id: 'topic_10_8',
      title: '10.8 Semafori per veicoli di trasporto pubblico: riconoscimento',
      italianText: `I semafori per veicoli di trasporto pubblico sono segnalazioni luminose particolari rivolte ai conducenti di tram, autobus, taxi e mezzi di linea. Usano simboli bianchi e un triangolo giallo, non le normali luci rosso-giallo-verde.

Non sono semafori pedonali, non preannunciano lavori e non indicano scambi dei binari. Funzionano insieme agli altri semafori dell'incrocio, ma valgono solo per i veicoli di trasporto pubblico indicati.`,
      farsiTranslation: `چراغ‌های مخصوص حمل‌ونقل عمومی برای رانندگان ترام، اتوبوس، تاکسی و وسایل خطی هستند. به جای چراغ‌های معمولی قرمز-زرد-سبز از علامت‌های سفید و مثلث زرد استفاده می‌کنند.

این چراغ‌ها چراغ عابر پیاده نیستند، کارگاه را هشدار نمی‌دهند و سوزن ریل را نشان نمی‌دهند. با چراغ‌های دیگر تقاطع هماهنگ‌اند، اما فقط برای وسایل حمل‌ونقل عمومی مربوط اعتبار دارند.`,
      vocabularyIds: [
        'indica',
        'non_indica',
        'solo',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_8_${i + 1}`)
    },
    {
      id: 'topic_10_9',
      title: '10.9 Semafori per veicoli di trasporto pubblico: significato',
      italianText: `La barra bianca orizzontale in alto impone l'arresto ai veicoli di trasporto pubblico. La barra bianca verticale in basso indica via libera. Una barra bianca inclinata consente di procedere a destra o a sinistra secondo l'inclinazione.

Il triangolo giallo al centro è un preavviso di arresto. Questi segnali non valgono per tutti i veicoli su rotaie e non regolano pedoni, passaggi a livello o pontili di imbarco.`,
      farsiTranslation: `نوار سفید افقی در بالا یعنی وسایل حمل‌ونقل عمومی باید توقف کنند. نوار سفید عمودی در پایین یعنی راه باز است. نوار سفید مورب اجازه حرکت به راست یا چپ را طبق جهت مورب می‌دهد.

مثلث زرد وسط یعنی هشدار توقف نزدیک است. این چراغ‌ها برای همه وسایل ریلی نیستند و عابران، گذرگاه راه‌آهن یا اسکله کشتی را تنظیم نمی‌کنند.`,
      vocabularyIds: [
        'indica',
        'solo',
        'veicoli',
      ...
      questionIds: Array.from({ length: 9 }, (_, i) => `q_10_9_${i + 1}`)
    },
    {
      id: 'topic_10_10',
      title: '10.10 Semafori pedonali: riconoscimento',
      italianText: `Il semaforo pedonale regola l'attraversamento dei pedoni negli incroci o sugli attraversamenti pedonali. Può essere dotato di segnalazione acustica per persone non vedenti.

È riservato ai pedoni e non regola il traffico dei veicoli. La forma e i simboli servono a distinguere chiaramente il comportamento richiesto a chi attraversa a piedi.`,
      farsiTranslation: `چراغ عابر پیاده عبور عابران را در تقاطع یا محل عبور عابر تنظیم می‌کند. ممکن است برای افراد نابینا علامت صوتی هم داشته باشد.

این چراغ مخصوص عابران است و ترافیک خودروها را تنظیم نمی‌کند. شکل و علامت‌های آن کمک می‌کنند عابر بداند چه زمانی باید بایستد یا عبور کند.`,
      vocabularyIds: [
        'indica',
        'strada',
        'solo',
      ...
      questionIds: Array.from({ length: 9 }, (_, i) => `q_10_10_${i + 1}`)
    },
    {
      id: 'topic_10_11',
      title: '10.11 Semafori pedonali: comportamento',
      italianText: `Con luce rossa i pedoni devono fermarsi prima dell'attraversamento. Con luce verde possono attraversare nella direzione indicata dalla luce. Con luce gialla fissa, se hanno già iniziato l'attraversamento, devono completarlo rapidamente; se sono ancora sul marciapiede, devono fermarsi.

Quando il semaforo pedonale permette il passaggio, i conducenti devono dare precedenza ai pedoni che attraversano.`,
      farsiTranslation: `با چراغ قرمز، عابر باید قبل از محل عبور بایستد. با چراغ سبز می‌تواند در جهت نشان‌داده‌شده عبور کند. با زرد ثابت، اگر عبور را شروع کرده باید سریع تمام کند؛ اگر هنوز روی پیاده‌روست باید بایستد.

وقتی چراغ عابر اجازه عبور می‌دهد، رانندگان باید به عابران در حال عبور حق تقدم بدهند.`,
      vocabularyIds: [
        'indica',
        'se',
        'comportamento',
      ...
      questionIds: Array.from({ length: 10 }, (_, i) => `q_10_11_${i + 1}`)
    },
    {
      id: 'topic_10_12',
      title: '10.12 Semafori per velocipedi',
      italianText: `Il semaforo per velocipedi è riservato alle biciclette e di solito si trova sulle piste ciclabili per regolare l'attraversamento della carreggiata. Non vale per tutti i veicoli a due ruote, quindi non riguarda motocicli e ciclomotori.

Con luce verde consente l'attraversamento ai velocipedi. Con luce gialla fissa impone di sgomberare l'incrocio se già impegnato. Con luce rossa impone l'arresto.`,
      farsiTranslation: `چراغ مخصوص دوچرخه برای دوچرخه‌هاست و معمولا در مسیرهای دوچرخه برای عبور از سواره‌رو نصب می‌شود. برای همه وسایل دوچرخ نیست؛ پس موتورسیکلت و موتورگازی را شامل نمی‌شود.

چراغ سبز اجازه عبور به دوچرخه می‌دهد. زرد ثابت یعنی اگر وارد تقاطع شده، باید آن را خالی کند. قرمز یعنی توقف.`,
      vocabularyIds: [
        'indica',
        'strada',
        'se',
      ...
      questionIds: Array.from({ length: 11 }, (_, i) => `q_10_12_${i + 1}`)
    },
    {
      id: 'topic_10_13',
      title: '10.13 Semafori per corsie reversibili: riconoscimento',
      italianText: `Le lanterne per corsie reversibili si usano su corsie che possono cambiare senso di marcia, per esempio in carreggiate con più corsie o presso caselli autostradali. Il segnale più importante è la X rossa, che vieta di usare la corsia sottostante.

La freccia verde indica la corsia che si può occupare. Questi semafori non servono a regolare un normale incrocio, ma l'uso delle corsie.`,
      farsiTranslation: `چراغ‌های مسیر برگشت‌پذیر برای لاین‌هایی هستند که ممکن است جهت استفاده‌شان عوض شود، مثلا در مسیرهای چندلاین یا نزدیک عوارضی. مهم‌ترین علامت X قرمز است که استفاده از لاین زیر آن را ممنوع می‌کند.

فلش سبز لاینی را نشان می‌دهد که می‌توانی از آن استفاده کنی. این چراغ‌ها تقاطع معمولی را تنظیم نمی‌کنند؛ استفاده از لاین‌ها را مشخص می‌کنند.`,
      vocabularyIds: [
        'indica',
        'solo',
        'almeno',
      ...
      questionIds: Array.from({ length: 7 }, (_, i) => `q_10_13_${i + 1}`)
    },
    {
      id: 'topic_10_14',
      title: '10.14 Semafori per corsie reversibili: comportamento',
      italianText: `Se sopra una corsia c'è una X rossa, quella corsia non deve essere percorsa e non bisogna fermarsi lì aspettando il verde. Se c'è freccia verde, la corsia è utilizzabile.

La freccia gialla lampeggiante avvisa che la corsia sta per chiudersi: bisogna abbandonarla al più presto e spostarsi verso una corsia con freccia verde.`,
      farsiTranslation: `اگر بالای یک لاین X قرمز باشد، نباید از آن لاین عبور کنی و نباید همان‌جا بایستی و منتظر سبز شوی. اگر فلش سبز باشد، آن لاین قابل استفاده است.

فلش زرد چشمک‌زن یعنی آن لاین به زودی بسته می‌شود؛ باید هرچه زودتر آن را ترک کنی و به لاینی بروی که فلش سبز دارد.`,
      vocabularyIds: [
        'se',
        'corsie',
        'corsia',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_14_${i + 1}`)
    },
    {
      id: 'topic_10_15',
      title: '10.15 Luce gialla lampeggiante',
      italianText: `La luce gialla lampeggiante è un segnale di prudenza. Può indicare un pericolo generico, un punto pericoloso della strada o un semaforo spento o guasto.

Quando la si incontra, bisogna diminuire la velocità, procedere con particolare attenzione e rispettare le precedenze, soprattutto quella dei veicoli provenienti da destra quando il semaforo normale non funziona.`,
      farsiTranslation: `چراغ زرد چشمک‌زن یعنی احتیاط. می‌تواند خطر عمومی، نقطه خطرناک جاده یا خاموش/خراب بودن چراغ راهنمایی را نشان دهد.

وقتی آن را می‌بینی باید سرعت را کم کنی، با دقت عبور کنی و حق تقدم‌ها را رعایت کنی؛ مخصوصا وقتی چراغ معمولی کار نمی‌کند، حق تقدم وسایل سمت راست مهم است.`,
      vocabularyIds: [
        'indica',
        'strada',
        'diminuire',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_15_${i + 1}`)
    },
    {
      id: 'topic_10_16',
      title: '10.16 Lanterne gialle lampeggianti A, B e C',
      italianText: `Le lanterne gialle lampeggianti possono avere funzioni diverse. Il tipo A compare quando il semaforo è spento o guasto e prescrive prudenza, velocità ridotta e precedenza ai veicoli di destra.

I tipi B e C sono accanto a un semaforo normale e ricordano a chi svolta di dare precedenza rispettivamente ai pedoni o ai ciclisti. Non sono luci fisse e non indicano piste pedonali o ciclabili.`,
      farsiTranslation: `چراغ‌های زرد چشمک‌زن می‌توانند کاربردهای متفاوت داشته باشند. نوع A وقتی چراغ خاموش یا خراب است دیده می‌شود و می‌گوید با احتیاط، سرعت کم و رعایت حق تقدم سمت راست عبور کن.

نوع B و C کنار چراغ معمولی می‌آیند و به راننده‌ای که می‌پیچد یادآوری می‌کنند به ترتیب به عابر یا دوچرخه‌سوار حق تقدم بدهد. این‌ها چراغ ثابت نیستند و مسیر عابر یا دوچرخه را نشان نمی‌دهند.`,
      vocabularyIds: [
        'indica',
        'non_indica',
        'strada',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_16_${i + 1}`)
    },
    {
      id: 'topic_10_17',
      title: '10.17 Luci rosse lampeggianti alternativamente',
      italianText: `Le luci rosse lampeggianti alternativamente vietano il passaggio di veicoli e pedoni. Di norma sono poste sul lato destro della carreggiata e obbligano a non superare il limite indicato, spesso segnato da una striscia bianca trasversale.

Si possono trovare vicino a passaggi a livello senza barriere o con semibarriere, all'accesso di pontili d'imbarco, presso ponti mobili o in situazioni particolari come aerei in atterraggio o decollo.`,
      farsiTranslation: `چراغ‌های قرمز چشمک‌زن متناوب عبور وسایل نقلیه و عابران را ممنوع می‌کنند. معمولا در سمت راست سواره‌رو نصب می‌شوند و اجازه نمی‌دهند از حد مشخص‌شده، مثل خط سفید عرضی، جلوتر بروی.

این چراغ‌ها ممکن است نزدیک گذرگاه راه‌آهن بدون مانع یا با نیم‌مانع، ورودی اسکله کشتی، پل متحرک یا شرایط خاص مثل فرود و برخاست هواپیما دیده شوند.`,
      vocabularyIds: [
        'vicino',
        'arrestarsi',
        'veicoli',
        ...
        'confine',
        'luce_verde',
        'lampeggianti_alternativamente',
        'arresto',
        'navi_traghetto',
        'ponti_mobili'
      ],
      questionIds: Array.from({ length: 10 }, (_, i) => `q_10_17_${i + 1}`)
    },
    {
      id: 'topic_10_18',
      title: '10.18 Luci rosse lampeggianti ai passaggi a livello',
      italianText: `Nei passaggi a livello senza barriere le luci rosse lampeggianti entrano in funzione poco prima dell'arrivo del treno. Nei passaggi con semibarriere funzionano subito prima dell'inizio dell'abbassamento delle barriere.

Continuano fino alla fine del passaggio del treno. Non sono una segnalazione per i treni e non sono luci rosse fisse: sono luci rosse lampeggianti alternate per fermare strada e pedoni.`,
      farsiTranslation: `در گذرگاه راه‌آهن بدون مانع، چراغ‌های قرمز چشمک‌زن کمی قبل از رسیدن قطار روشن می‌شوند. در گذرگاه با نیم‌مانع، درست قبل از پایین آمدن مانع‌ها شروع به کار می‌کنند.

تا پایان عبور قطار ادامه دارند. این علامت برای قطارها نیست و چراغ قرمز ثابت هم نیست؛ چراغ قرمز چشمک‌زن متناوب است تا خودروها و عابران را متوقف کند.`,
      vocabularyIds: [
        'strada',
        'se',
        'in_funzione',
      ...
      questionIds: Array.from({ length: 14 }, (_, i) => `q_10_18_${i + 1}`)
    },
    {
      id: 'topic_10_19',
      title: '10.19 Comportamento con luci rosse lampeggianti',
      italianText: `Quando le luci rosse lampeggianti sono in funzione, bisogna fermarsi prima della striscia trasversale o del limite indicato e non attraversare. La regola vale sia per i veicoli sia per i pedoni.

Non bisogna confonderle con la luce gialla lampeggiante, che indica prudenza ma non vieta sempre il passaggio. Con rosso lampeggiante alternato, invece, il passaggio è vietato.`,
      farsiTranslation: `وقتی چراغ‌های قرمز چشمک‌زن کار می‌کنند، باید قبل از خط عرضی یا حد مشخص‌شده بایستی و عبور نکنی. این قانون هم برای وسایل نقلیه است و هم برای عابران.

نباید آن را با زرد چشمک‌زن اشتباه گرفت؛ زرد چشمک‌زن یعنی احتیاط، اما همیشه عبور را ممنوع نمی‌کند. قرمز چشمک‌زن متناوب یعنی عبور ممنوع است.`,
      vocabularyIds: [
        'indica',
        'se',
        'solo',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_19_${i + 1}`)
    },
    {
      id: 'topic_10_20',
      title: '10.20 Semafori di onda verde',
      italianText: `I semafori di onda verde sono semafori sincronizzati su itinerari con più incroci. Consigliano al conducente una velocità da mantenere, indicata da un simbolo luminoso bianco, per trovare il verde ai semafori successivi.

La velocità indicata è consigliata, non obbligatoria, e si accende un solo simbolo alla volta. Non indicano velocità massima, non funzionano quando sono spenti e non si trovano in autostrada, perché in autostrada non ci sono incroci regolati da semaforo.`,
      farsiTranslation: `چراغ‌های موج سبز چراغ‌های هماهنگ‌شده در مسیرهایی با چند تقاطع هستند. به راننده سرعتی را پیشنهاد می‌کنند که اگر حفظ کند، احتمالاً در چراغ‌های بعدی به سبز می‌رسد.

این سرعت پیشنهادی است، نه اجباری، و هر بار فقط یک علامت سفید روشن می‌شود. سرعت حداکثر نیست، وقتی چراغ خاموش است معنی ندارد و در اتوبان نصب نمی‌شود، چون اتوبان تقاطع چراغ‌دار ندارد.`,
      vocabularyIds: [
        'indica',
        'non_indica',
        'se',
        ...
        'luce_verde',
        'onda_verde',
        'semafori_sincronizzati',
        'simbolo_luminoso',
        'velocita_indicata'
      ],
      questionIds: Array.from({ length: 15 }, (_, i) => `q_10_20_${i + 1}`)
    },
    {
      id: 'topic_10_21',
      title: '10.21 Dare precedenza nei sensi unici alternati con semaforo o agente',
      italianText: `Nei sensi unici alternati, il segnale di dare precedenza può essere accompagnato da un semaforo a tre luci o dalle indicazioni dell'agente del traffico. Se il semaforo è verde, si può passare; se è spento o a luce gialla lampeggiante, bisogna dare la precedenza al traffico che arriva dal senso opposto.

Gli ordini dell'agente prevalgono sul semaforo e sui segnali verticali: se l'agente ordina di passare, si passa anche quando il semaforo è rosso; se ordina di fermarsi, bisogna fermarsi anche con luce verde.`,
      farsiTranslation: `در راه‌هایی که عبور دوطرفه به صورت نوبتی انجام می‌شود، تابلوی «دادن حق تقدم» ممکن است همراه با چراغ سه‌رنگ یا دستور مأمور راهنمایی باشد. اگر چراغ سبز باشد، می‌توانی عبور کنی؛ اگر چراغ خاموش باشد یا زرد چشمک‌زن باشد، باید به وسیله‌ای که از جهت مقابل می‌آید حق تقدم بدهی.

دستور مأمور از چراغ و تابلو مهم‌تر است: اگر مأمور دستور عبور بدهد، حتی با چراغ قرمز می‌توان عبور کرد؛ اگر دستور توقف بدهد، حتی با چراغ سبز باید توقف کرد.`,
      vocabularyIds: [
        'dare_precedenza',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_21_${i + 1}`)
    },
    {
      id: 'topic_10_22',
      title: '10.22 Diritto di precedenza nei sensi unici alternati con semaforo o agente',
      italianText: `Il segnale di diritto di precedenza nei sensi unici alternati indica che, normalmente, abbiamo la precedenza rispetto ai veicoli provenienti dal senso opposto. Con semaforo a tre luci, la precedenza resta se la luce è verde, se il semaforo è spento o se è a luce gialla lampeggiante.

Anche qui l'agente del traffico prevale: se ci ordina di passare, abbiamo la precedenza anche con luce rossa; se ci ordina di fermarci, dobbiamo dare la precedenza anche quando il semaforo è spento o verde.`,
      farsiTranslation: `تابلوی «حق تقدم عبور در راه باریک نوبتی» یعنی به طور معمول ما نسبت به خودروهایی که از جهت مقابل می‌آیند حق تقدم داریم. اگر چراغ سه‌رنگ باشد، با چراغ سبز، چراغ خاموش یا چراغ زرد چشمک‌زن، حق تقدم با ماست.

اینجا هم دستور مأمور از همه مهم‌تر است: اگر مأمور دستور عبور بدهد، حتی با چراغ قرمز حق عبور داریم؛ اگر دستور توقف بدهد، حتی وقتی چراغ خاموش یا سبز است باید حق تقدم بدهیم.`,
      vocabularyIds: [
      ...
      questionIds: Array.from({ length: 9 }, (_, i) => `q_10_22_${i + 1}`)
    },
    {
      id: 'topic_10_23',
      title: '10.23 Vigile in posizione di ALT',
      italianText: `Il vigile posto di fronte o di spalle al conducente, con le braccia aperte perpendicolarmente alla nostra direzione di marcia, equivale alla luce rossa del semaforo.

Bisogna fermarsi prima della striscia di arresto, non attraversare l'incrocio e non svoltare né a destra né a sinistra. Le segnalazioni del vigile prevalgono sempre sui semafori e sugli altri segnali.`,
      farsiTranslation: `اگر مأمور روبه‌روی تو یا پشت به تو باشد و دست‌هایش نسبت به مسیر تو عمود باز شده باشد، معنی آن مثل چراغ قرمز است.

باید قبل از خط توقف بایستی، وارد تقاطع نشوی و نه به راست و نه به چپ نپیچی. علامت مأمور همیشه از چراغ و تابلوهای دیگر مهم‌تر است.`,
      vocabularyIds: [
        'se',
        'vietato',
        'arrestarsi',
      ...
      questionIds: Array.from({ length: 11 }, (_, i) => `q_10_23_${i + 1}`)
    },
    {
      id: 'topic_10_24',
      title: '10.24 Vigile in posizione di AVANTI',
      italianText: `Il vigile disposto di profilo rispetto alla nostra direzione di marcia equivale alla luce verde del semaforo. Si può attraversare l'incrocio in tutte le direzioni, ma usando prudenza.

Chi svolta a destra deve dare precedenza ai pedoni che attraversano la strada trasversale. Chi svolta a sinistra deve dare precedenza ai pedoni e ai veicoli provenienti di fronte.`,
      farsiTranslation: `اگر مأمور به صورت نیمرخ نسبت به مسیر تو ایستاده باشد، معنی آن مثل چراغ سبز است. می‌توانی با احتیاط از تقاطع عبور کنی و جهت‌های مجاز را انتخاب کنی.

اگر به راست می‌پیچی باید به عابران مسیر عرضی حق تقدم بدهی. اگر به چپ می‌پیچی باید به عابران و وسایل نقلیه روبه‌رو حق تقدم بدهی.`,
      vocabularyIds: [
        'strada',
        'se',
        'veicoli',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_24_${i + 1}`)
    },
    {
      id: 'topic_10_25',
      title: '10.25 Vigile con un braccio alzato',
      italianText: `Il vigile con un braccio alzato equivale alla luce gialla fissa del semaforo. Preannuncia un cambiamento della direzione di marcia consentita.

Se si può fare in sicurezza, bisogna arrestarsi prima dell'incrocio. Se invece l'incrocio è già impegnato, bisogna sgomberarlo subito. Non è un segnale riservato solo a chi deve svoltare.`,
      farsiTranslation: `مأمور با یک دست بالا مثل چراغ زرد ثابت است. یعنی جهت‌های مجاز حرکت به زودی تغییر می‌کنند.

اگر با ایمنی ممکن است، باید قبل از تقاطع بایستی. اگر وارد تقاطع شده‌ای، باید سریع آن را خالی کنی. این علامت فقط مخصوص کسانی که می‌خواهند بپیچند نیست.`,
      vocabularyIds: [
        'se',
        'solo',
        'pericolo',
      ...
      questionIds: Array.from({ length: 8 }, (_, i) => `q_10_25_${i + 1}`)
    },
    {
      id: 'topic_10_26',
      title: '10.26 Vigile con braccia ad angolo retto',
      italianText: `Quando il vigile tiene le braccia ad angolo retto, consente il passaggio solo ad alcune correnti di traffico. In particolare possono proseguire, svoltare a destra o a sinistra i veicoli che provengono dalla sua sinistra.

Sono invece fermati i veicoli provenienti dalla sua destra, dalle sue spalle e quelli che gli vengono di fronte. Anche in questo caso la posizione del vigile prevale sui segnali luminosi.`,
      farsiTranslation: `وقتی مأمور دست‌هایش را با زاویه راست نگه می‌دارد، عبور فقط برای بعضی جریان‌های ترافیک مجاز است. به طور خاص، وسایلی که از سمت چپ مأمور می‌آیند می‌توانند مستقیم بروند یا به راست و چپ بپیچند.

اما وسایلی که از سمت راست مأمور، از پشت او یا از روبه‌رو می‌آیند باید بایستند. در این حالت هم وضعیت مأمور از چراغ‌ها مهم‌تر است.`,
      vocabularyIds: [
        'solo',
        'veicoli',
        'veicoli_provenienti',
      ...
      questionIds: Array.from({ length: 10 }, (_, i) => `q_10_26_${i + 1}`)
    },
    {
      id: 'topic_10_27',
      title: '10.27 Suono prolungato del fischietto',
      italianText: `Il suono prolungato del fischietto da parte del vigile significa che tutta la circolazione deve fermarsi. Equivale a un semaforo con luce rossa accesa contemporaneamente per tutte le direzioni.

Serve soprattutto per lasciare libero il passaggio ai veicoli di soccorso, come ambulanza o polizia. Il conducente deve fermarsi e non occupare l'incrocio o il passaggio che deve restare libero.`,
      farsiTranslation: `صدای طولانی سوت مأمور یعنی همه جریان‌های عبور باید توقف کنند. معنی آن مثل این است که چراغ قرمز هم‌زمان برای همه جهت‌ها روشن شده باشد.

این کار معمولا برای باز کردن مسیر وسایل امدادی مثل آمبولانس یا پلیس است. راننده باید توقف کند و تقاطع یا مسیر عبور را اشغال نکند.`,
      vocabularyIds: [
        'veicoli',
        'contemporaneamente',
        'incrocio',
  ...
  questions: [
    ...
    },
    {
      ...
      farsiTranslation: 'در حضور تابلوی نشان‌داده‌شده و چراغ سه‌رنگ، اگر چراغ سبز باشد ما حق تقدم داریم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_21_2',
      ...
      farsiTranslation: 'در حضور تابلوی نشان‌داده‌شده و چراغ سه‌رنگ، اگر چراغ خاموش باشد باید حق تقدم بدهیم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_21_3',
      ...
      farsiTranslation: 'اگر چراغ قرمز باشد ولی مأمور راهنمایی دستور عبور بدهد، با این تابلو ما حق تقدم داریم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_21_4',
      ...
      farsiTranslation: 'اگر چراغ زرد چشمک‌زن باشد، با این تابلو باید حق تقدم بدهیم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_21_5',
      ...
      farsiTranslation: 'با این تابلو، حتی اگر چراغ سبز باشد باید حق تقدم بدهیم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_21_6',
      ...
      farsiTranslation: 'با این تابلو، اگر چراغ زرد چشمک‌زن باشد ما حق تقدم داریم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_21_7',
      italianText: 'In presenza del segnale raffigurato e del semaforo a tre luci abbiamo la precedenza se il semaforo è a luce verde, ma l’agente del traffico ci ordina di fermarci',
      farsiTranslation: 'اگر چراغ سبز باشد ولی مأمور دستور توقف بدهد، باز هم ما حق تقدم داریم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_21_8',
      italianText: 'In presenza del segnale raffigurato e del semaforo a tre luci dobbiamo dare la precedenza se il semaforo è spento e l’agente del traffico ci ordina di passare',
      farsiTranslation: 'اگر چراغ خاموش باشد و مأمور دستور عبور بدهد، باید حق تقدم بدهیم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_22_1',
    ...
    },
    {
      ...
      farsiTranslation: 'با این تابلو، اگر چراغ خاموش باشد ما حق تقدم داریم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_22_3',
      italianText: 'In presenza del segnale raffigurato e del semaforo a tre luci abbiamo la precedenza se il semaforo è a luce rossa, ma l’agente del traffico ci ordina di passare',
      farsiTranslation: 'اگر چراغ قرمز باشد ولی مأمور دستور عبور بدهد، ما حق تقدم داریم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_22_4',
      ...
      farsiTranslation: 'اگر چراغ خاموش باشد و مأمور دستور توقف بدهد، باید حق تقدم بدهیم.',
      correctAnswer: 'Vero'
    },
    {
      id: 'q_10_22_5',
    ...
    },
    {
      ...
      farsiTranslation: 'با این تابلو، حتی اگر چراغ قرمز باشد همیشه حق تقدم داریم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_22_7',
      italianText: 'In presenza del segnale raffigurato e del semaforo a tre luci dobbiamo dare la precedenza se il semaforo è a luce lampeggiante gialla',
      farsiTranslation: 'با این تابلو، اگر چراغ زرد چشمک‌زن باشد باید حق تقدم بدهیم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_22_8',
      ...
      farsiTranslation: 'اگر چراغ سبز باشد ولی مأمور دستور توقف بدهد، ما حق تقدم داریم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_22_9',
      ...
      farsiTranslation: 'اگر چراغ خاموش باشد و مأمور دستور توقف بدهد، ما حق تقدم داریم.',
      correctAnswer: 'Falso'
    },
    {
      id: 'q_10_23_1',
