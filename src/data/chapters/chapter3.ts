...
export const chapter3: Chapter = {
  ...
  farsiTitle: 'تابلوهای حق تقدم',
  lessons: [
    {
      id: 'topic_3_1',
      title: '3.1 Dare precedenza',
      italianText: `I segnali di precedenza fanno parte dei segnali di prescrizione. Possono imporre di dare la precedenza oppure indicare che si gode del diritto di precedenza; avere la precedenza, però, non esonera mai dalla prudenza e dal controllo del comportamento degli altri conducenti.

Il segnale DARE PRECEDENZA prescrive di dare la precedenza ai veicoli che circolano sulla strada che si incrocia o sulla quale ci si immette, sia da destra sia da sinistra. È collocato su una strada secondaria urbana o extraurbana priva del diritto di precedenza, anche sulle rampe e sulle corsie di accelerazione per l'immissione in autostrada. Di norma è installato circa 25 metri prima dell'incrocio.

Sulle strade extraurbane è preceduto dal PREAVVISO DI DARE PRECEDENZA, non dal preavviso di STOP. Se è abbinato a un semaforo, conserva efficacia quando il semaforo è spento, guasto o funziona a luce gialla lampeggiante. Bisogna moderare la velocità, usare la massima prudenza e fermarsi solo quando è necessario per concedere la precedenza. Il segnale non viene collocato lungo l'autostrada, ma sulla corsia d'ingresso.`,
      farsiTranslation: `تابلوهای حق تقدم جزو تابلوهای دستوری هستند. ممکن است راننده را ملزم به دادن حق تقدم کنند یا نشان دهند که او دارای حق تقدم است؛ بااین‌حال داشتن حق تقدم هرگز راننده را از احتیاط و بررسی رفتار دیگر رانندگان بی‌نیاز نمی‌کند.

تابلوی «رعایت حق تقدم» راننده را ملزم می‌کند به وسایل نقلیه‌ای که در جادهٔ متقاطع یا جاده‌ای که وارد آن می‌شود حرکت می‌کنند، چه از راست و چه از چپ، حق تقدم بدهد. این تابلو در جادهٔ فرعی شهری یا برون‌شهری که حق تقدم ندارد نصب می‌شود؛ از جمله روی رمپ‌ها و خطوط شتاب‌گیری برای ورود به بزرگراه. معمولاً حدود ۲۵ متر پیش از تقاطع قرار می‌گیرد.
...
در جاده‌های برون‌شهری، پیش از آن تابلوی «پیش‌آگهی رعایت حق تقدم» قرار می‌گیرد، نه پیش‌آگهی STOP. اگر تابلو همراه چراغ راهنمایی باشد، هنگامی که چراغ خاموش، خراب یا زرد چشمک‌زن است اعتبار دارد. باید سرعت را کاهش داد، با حداکثر احتیاط حرکت کرد و فقط هنگامی توقف کرد که برای دادن حق تقدم لازم باشد. این تابلو در طول بزرگراه نصب نمی‌شود، بلکه روی خط ورود قرار می‌گیرد.`,
    ...
    {
      id: 'topic_3_2',
      title: '3.2 Fermarsi e dare precedenza (STOP)',
      italianText: `Il segnale FERMARSI E DARE PRECEDENZA (STOP) obbliga ad arrestarsi in corrispondenza della striscia trasversale di arresto, anche quando non sopraggiunge nessun veicolo. Dopo l'arresto bisogna dare la precedenza ai veicoli provenienti sia da destra sia da sinistra.

È posto su una strada secondaria che incontra una strada con diritto di precedenza, di norma circa 25 metri prima dell'incrocio. Si usa soprattutto negli incroci con visibilità insufficiente o particolarmente pericolosi e può trovarsi anche in corrispondenza di un passaggio a livello. Fuori dai centri abitati è preceduto dal relativo segnale di preavviso.

Se il semaforo è spento, guasto o funziona a luce gialla lampeggiante, bisogna comunque fermarsi. Con la luce verde, invece, si può proseguire senza applicare l'obbligo di arresto imposto dal segnale. Lo STOP non indica un varco doganale, un posto di blocco o il senso unico alternato.`,
      farsiTranslation: `تابلوی «ایست و رعایت حق تقدم» یا STOP راننده را ملزم می‌کند در محل خط عرضی ایست کاملاً متوقف شود، حتی اگر هیچ وسیلهٔ نقلیه‌ای در حال نزدیک‌شدن نباشد. پس از توقف باید به وسایل نقلیه‌ای که از راست و چپ می‌آیند حق تقدم داد.

این تابلو در جادهٔ فرعی که با جاده‌ای دارای حق تقدم تقاطع دارد و معمولاً حدود ۲۵ متر پیش از تقاطع نصب می‌شود. بیشتر در تقاطع‌های کم‌دید یا بسیار خطرناک به کار می‌رود و ممکن است در محل گذرگاه راه‌آهن نیز قرار داشته باشد. خارج از محدودهٔ شهری، پیش از آن تابلوی پیش‌آگهی مربوط نصب می‌شود.
...
اگر چراغ راهنمایی خاموش، خراب یا زرد چشمک‌زن باشد، همچنان باید توقف کرد. اما با روشن بودن چراغ سبز می‌توان بدون اجرای الزام توقف تابلو عبور کرد. STOP نشان‌دهندهٔ گمرک، ایست بازرسی یا عبور نوبتی در مسیر باریک نیست.`,
    ...
    {
      id: 'topic_3_3',
      title: '3.3 Preavviso di dare precedenza',
      italianText: `Il PREAVVISO DI DARE PRECEDENZA annuncia la successiva presenza del segnale DARE PRECEDENZA e indica la distanza dall'incrocio nel quale si dovrà concedere la precedenza ai veicoli provenienti da destra e da sinistra.

Segnala che la strada percorsa non gode del diritto di precedenza. Bisogna quindi rallentare in modo da potersi fermare se sopraggiungono veicoli ai quali occorre dare la precedenza. Può essere posto anche prima di un incrocio a T.

Non è un preavviso di STOP e non impone di arrestarsi obbligatoriamente all'incrocio quando non vi sono veicoli in arrivo.`,
      farsiTranslation: `تابلوی «پیش‌آگهی رعایت حق تقدم» خبر می‌دهد که در ادامه تابلوی رعایت حق تقدم وجود دارد و فاصله تا تقاطعی را نشان می‌دهد که در آن باید به وسایل نقلیهٔ ورودی از راست و چپ حق تقدم داد.

این تابلو نشان می‌دهد جاده‌ای که در آن حرکت می‌کنیم دارای حق تقدم نیست. بنابراین باید سرعت را کاهش داد تا اگر وسیله‌ای نزدیک شد که باید به آن حق تقدم بدهیم، بتوانیم توقف کنیم. این تابلو ممکن است پیش از یک تقاطع T شکل نیز نصب شود.
...
این تابلو پیش‌آگهی STOP نیست و اگر هیچ وسیله‌ای در حال نزدیک‌شدن نباشد، توقف اجباری در تقاطع را تحمیل نمی‌کند.`,
    ...
    {
      id: 'topic_3_4',
      title: '3.4 Preavviso di fermarsi e dare precedenza',
      italianText: `Il PREAVVISO DI FERMARSI E DARE PRECEDENZA annuncia la presenza di un segnale di STOP alla distanza riportata sul segnale; nell'esempio, lo STOP si trova 320 metri più avanti.

Dal momento in cui si incontra il preavviso bisogna iniziare a moderare la velocità, per essere pronti a fermarsi obbligatoriamente presso il successivo STOP e a dare la precedenza ai veicoli provenienti da destra e da sinistra.

Il preavviso non impone di fermarsi nel punto in cui è collocato e non annuncia una barriera doganale, un casello autostradale o un posto di blocco della polizia.`,
      farsiTranslation: `تابلوی «پیش‌آگهی ایست و رعایت حق تقدم» وجود تابلوی STOP را در فاصله‌ای که روی تابلو نوشته شده اعلام می‌کند؛ در نمونه، تابلوی STOP در ۳۲۰ متر جلوتر قرار دارد.

از زمان مشاهدهٔ پیش‌آگهی باید کاهش سرعت را آغاز کرد تا برای توقف اجباری در محل STOP بعدی و دادن حق تقدم به وسایل نقلیهٔ ورودی از راست و چپ آماده باشیم.
...
این پیش‌آگهی راننده را ملزم نمی‌کند در همان محل نصب آن توقف کند و نشان‌دهندهٔ مانع گمرکی، باجهٔ عوارض بزرگراه یا ایست بازرسی پلیس نیست.`,
    ...
    {
      id: 'topic_3_5',
      title: '3.5 Intersezione con precedenza a destra',
      italianText: `Il segnale INTERSEZIONE CON PRECEDENZA A DESTRA preannuncia un incrocio nel quale vale la regola generale: bisogna dare la precedenza ai veicoli provenienti da destra.

Di norma è collocato 150 metri prima dell'incrocio e non viene impiegato sulle strade che godono del diritto di precedenza. Occorre procedere a velocità particolarmente moderata, concedere la precedenza a destra e assicurarsi che i conducenti provenienti da sinistra siano disposti a darcela.

Il segnale non precede un DARE PRECEDENZA o uno STOP: in presenza di questi segnali si dovrebbe infatti dare la precedenza sia a destra sia a sinistra.`,
      farsiTranslation: `تابلوی «تقاطع با حق تقدم از راست» تقاطعی را از پیش اعلام می‌کند که در آن قانون عمومی اجرا می‌شود: باید به وسایل نقلیه‌ای که از راست می‌آیند حق تقدم داد.

این تابلو معمولاً ۱۵۰ متر پیش از تقاطع نصب می‌شود و در جاده‌هایی که دارای حق تقدم هستند به کار نمی‌رود. باید با سرعت بسیار کم حرکت کرد، به سمت راست حق تقدم داد و مطمئن شد رانندگانی که از چپ می‌آیند آماده‌اند به ما حق تقدم بدهند.
...
این تابلو پیش از تابلوی رعایت حق تقدم یا STOP قرار نمی‌گیرد؛ زیرا با وجود آن دو تابلو باید هم به راست و هم به چپ حق تقدم داد.`,
    ...
    {
      id: 'topic_3_6',
      title: '3.6 Intersezione con diritto di precedenza',
      italianText: `Il segnale INTERSEZIONE CON DIRITTO DI PRECEDENZA preannuncia, di norma a 150 metri, un incrocio nel quale si ha la precedenza sui veicoli provenienti dalle strade secondarie, sia da destra sia da sinistra.

Può essere preceduto dal segnale DIRITTO DI PRECEDENZA e perde efficacia quando il traffico è regolato da un agente. Pur avendo la precedenza, bisogna rallentare e verificare che i veicoli provenienti dalle strade laterali siano effettivamente disposti a concederla.

Non indica un incrocio a T né una confluenza con corsia di accelerazione e non viene posto sulle autostrade. Il segnale non vieta di svoltare.`,
      farsiTranslation: `تابلوی «تقاطع با داشتن حق تقدم» معمولاً از فاصلهٔ ۱۵۰ متری تقاطعی را اعلام می‌کند که در آن نسبت به وسایل نقلیهٔ ورودی از جاده‌های فرعی، چه از راست و چه از چپ، حق تقدم داریم.

ممکن است پیش از آن تابلوی «داشتن حق تقدم» قرار گرفته باشد و هنگامی که مأمور عبور و مرور ترافیک را هدایت می‌کند، اعتبارش را از دست می‌دهد. با وجود داشتن حق تقدم باید سرعت را کاهش داد و بررسی کرد که خودروهای جاده‌های جانبی واقعاً آمادهٔ دادن حق تقدم هستند.
...
این تابلو تقاطع T شکل یا محل ادغام مسیر با خط شتاب‌گیری را نشان نمی‌دهد و در بزرگراه نصب نمی‌شود. تابلو گردش‌کردن را ممنوع نمی‌کند.`,
    ...
    {
      id: 'topic_3_7',
      title: '3.7 Intersezione a T con diritto di precedenza a destra',
      italianText: `Il segnale INTERSEZIONE A T CON DIRITTO DI PRECEDENZA A DESTRA preannuncia un incrocio a T con una strada secondaria che si immette da destra. Chi percorre la strada principale ha la precedenza sui veicoli provenienti dalla strada laterale.

Bisogna usare la massima prudenza e accertarsi che i conducenti provenienti dalla strada subordinata concedano realmente la precedenza. È consentito svoltare a destra, mentre è vietato sostare o fermarsi in corrispondenza dell'intersezione.

Il segnale non indica una strada senza uscita, una confluenza o un'immissione con corsia di accelerazione e non viene collocato sulle rampe di accesso alle autostrade.`,
      farsiTranslation: `تابلوی «تقاطع T شکل با حق تقدم و ورود جاده از راست» تقاطعی T شکل را اعلام می‌کند که در آن یک جادهٔ فرعی از سمت راست وارد می‌شود. راننده‌ای که در جادهٔ اصلی حرکت می‌کند نسبت به خودروهای جادهٔ جانبی حق تقدم دارد.

باید با حداکثر احتیاط حرکت کرد و مطمئن شد رانندگانی که از جادهٔ فرعی می‌آیند واقعاً حق تقدم را رعایت می‌کنند. گردش به راست مجاز است، اما توقف کوتاه یا پارک‌کردن در محل تقاطع ممنوع است.
...
این تابلو بن‌بست، ادغام مسیر یا ورود همراه با خط شتاب‌گیری را نشان نمی‌دهد و روی رمپ‌های ورودی بزرگراه نصب نمی‌شود.`,
    ...
    {
      id: 'topic_3_8',
      title: '3.8 Intersezione a T con diritto di precedenza a sinistra',
      italianText: `Il segnale INTERSEZIONE A T CON DIRITTO DI PRECEDENZA A SINISTRA preannuncia un incrocio a T con una strada secondaria che si immette da sinistra. Chi percorre la strada principale ha la precedenza sui veicoli provenienti dalla strada laterale.

Bisogna usare la massima prudenza e accertarsi che i conducenti provenienti dalla strada subordinata concedano realmente la precedenza. È consentito svoltare a sinistra, mentre è vietato sostare o fermarsi in corrispondenza dell'intersezione.

Il segnale non indica una strada senza uscita, una confluenza o un'immissione con corsia di accelerazione e non viene collocato sulle rampe di accesso alle autostrade.`,
      farsiTranslation: `تابلوی «تقاطع T شکل با حق تقدم و ورود جاده از چپ» تقاطعی T شکل را اعلام می‌کند که در آن یک جادهٔ فرعی از سمت چپ وارد می‌شود. راننده‌ای که در جادهٔ اصلی حرکت می‌کند نسبت به خودروهای جادهٔ جانبی حق تقدم دارد.

باید با حداکثر احتیاط حرکت کرد و مطمئن شد رانندگانی که از جادهٔ فرعی می‌آیند واقعاً حق تقدم را رعایت می‌کنند. گردش به چپ مجاز است، اما توقف کوتاه یا پارک‌کردن در محل تقاطع ممنوع است.
...
این تابلو بن‌بست، ادغام مسیر یا ورود همراه با خط شتاب‌گیری را نشان نمی‌دهد و روی رمپ‌های ورودی بزرگراه نصب نمی‌شود.`,
    ...
    {
      id: 'topic_3_9',
      title: '3.9 Confluenza a destra',
      italianText: `Il segnale CONFLUENZA A DESTRA si trova sulla strada principale, anche in autostrada, e preannuncia l'ingresso da destra di una corsia di accelerazione. I veicoli che già percorrono la strada principale hanno la precedenza su quelli che si immettono.

È collocato, di norma, circa 150 metri prima della confluenza. Bisogna ridurre la velocità e usare la massima prudenza, perché i veicoli provenienti dalla rampa potrebbero non rispettare il segnale DARE PRECEDENZA installato sulla strada d'immissione.

Il segnale non prescrive di dare la precedenza ai veicoli provenienti da destra e non consente di svoltare a destra: la corsia di accelerazione è a senso unico e serve ai veicoli che entrano nella strada principale.`,
      farsiTranslation: `تابلوی «ادغام مسیر از راست» در جادهٔ اصلی، از جمله در بزرگراه، نصب می‌شود و ورود یک خط شتاب‌گیری از سمت راست را از پیش اعلام می‌کند. وسایل نقلیه‌ای که از قبل در جادهٔ اصلی حرکت می‌کنند نسبت به خودروهای در حال ورود حق تقدم دارند.

این تابلو معمولاً حدود ۱۵۰ متر پیش از محل ادغام نصب می‌شود. باید سرعت را کاهش داد و با حداکثر احتیاط حرکت کرد، زیرا ممکن است خودروهای رمپ، تابلوی رعایت حق تقدمی را که در مسیر ورودشان قرار دارد رعایت نکنند.
...
تابلو رانندهٔ جادهٔ اصلی را ملزم نمی‌کند به خودروهای سمت راست حق تقدم بدهد و اجازهٔ گردش به راست نیز نمی‌دهد؛ خط شتاب‌گیری یک‌طرفه است و برای ورود خودروها به جادهٔ اصلی استفاده می‌شود.`,
    ...
    {
      id: 'topic_3_10',
      title: '3.10 Confluenza a sinistra',
      italianText: `Il segnale CONFLUENZA A SINISTRA si trova sulle strade extraurbane principali o sulle carreggiate a senso unico e preannuncia l'ingresso da sinistra di una corsia di accelerazione. I veicoli che già percorrono la strada principale hanno la precedenza su quelli che si immettono.

È collocato, di norma, circa 150 metri prima della confluenza. Bisogna ridurre la velocità e usare prudenza, perché i veicoli provenienti dalla rampa potrebbero non rispettare il segnale DARE PRECEDENZA posto sulla strada laterale.

Il segnale non prescrive di dare la precedenza ai veicoli provenienti da sinistra e non consente di svoltare a sinistra: la corsia di accelerazione è a senso unico e serve soltanto per entrare nella strada principale.`,
      farsiTranslation: `تابلوی «ادغام مسیر از چپ» در جاده‌های اصلی برون‌شهری یا سواره‌روهای یک‌طرفه نصب می‌شود و ورود یک خط شتاب‌گیری از سمت چپ را از پیش اعلام می‌کند. وسایل نقلیه‌ای که از قبل در جادهٔ اصلی حرکت می‌کنند نسبت به خودروهای در حال ورود حق تقدم دارند.

این تابلو معمولاً حدود ۱۵۰ متر پیش از محل ادغام نصب می‌شود. باید سرعت را کاهش داد و با احتیاط حرکت کرد، زیرا ممکن است خودروهای رمپ، تابلوی رعایت حق تقدم موجود در جادهٔ جانبی را رعایت نکنند.
...
تابلو رانندهٔ جادهٔ اصلی را ملزم نمی‌کند به خودروهای سمت چپ حق تقدم بدهد و اجازهٔ گردش به چپ نیز نمی‌دهد؛ خط شتاب‌گیری یک‌طرفه است و فقط برای ورود به جادهٔ اصلی استفاده می‌شود.`,
    ...
    {
      id: 'topic_3_11',
      title: '3.11 Diritto di precedenza',
      italianText: `Il segnale DIRITTO DI PRECEDENZA indica l'inizio di una strada urbana o extraurbana che gode del diritto di precedenza. Sulle strade laterali che la incrociano devono trovarsi i segnali DARE PRECEDENZA o STOP.

Può essere ripetuto in formato ridotto prima e dopo gli incroci ed essere integrato con un pannello che mostra l'andamento della strada principale. In prossimità degli incroci bisogna comunque moderare la velocità e accertarsi che i veicoli provenienti dalle strade laterali siano disposti a concedere la precedenza. Occorre inoltre lasciare passare i veicoli di emergenza con sirena e lampeggiante blu in funzione.

Il segnale consente di proseguire diritto, svoltare e sorpassare, quando le altre norme lo permettono. Non obbliga a fermarsi agli incroci e non viene posto all'inizio di un'autostrada.`,
      farsiTranslation: `تابلوی «داشتن حق تقدم» آغاز یک جادهٔ شهری یا برون‌شهری را نشان می‌دهد که دارای حق تقدم است. در جاده‌های جانبی که با آن تقاطع دارند باید تابلوهای رعایت حق تقدم یا STOP نصب شده باشد.

این تابلو ممکن است با اندازهٔ کوچک‌تر پیش و پس از تقاطع‌ها تکرار شود و همراه صفحه‌ای باشد که مسیر جادهٔ اصلی را نشان می‌دهد. نزدیک تقاطع‌ها همچنان باید سرعت را کاهش داد و مطمئن شد خودروهای جاده‌های جانبی آمادهٔ دادن حق تقدم هستند. همچنین باید به خودروهای امدادی که آژیر و چراغ آبی آن‌ها روشن است راه داد.
...
اگر سایر مقررات اجازه دهند، این تابلو ادامهٔ مستقیم، گردش و سبقت را مجاز می‌گذارد. راننده را ملزم به توقف در تقاطع‌ها نمی‌کند و در آغاز بزرگراه نصب نمی‌شود.`,
    ...
    {
      id: 'topic_3_12',
      title: '3.12 Fine del diritto di precedenza',
      italianText: `Il segnale FINE DEL DIRITTO DI PRECEDENZA indica, sulle strade urbane ed extraurbane, che la strada non gode più del diritto di precedenza e che cambiano le precedenti regole applicate agli incroci.

Dopo il segnale si ripristina, di norma, la regola generale della precedenza a destra. Se invece si incontra un DARE PRECEDENZA o uno STOP, bisogna concedere la precedenza sia a destra sia a sinistra. La perdita del diritto di precedenza richiede maggiore prudenza.

Il segnale non indica la fine di un obbligo, di un'autostrada, di una strada a senso unico o a doppio senso, di un limite di velocità o di tutti i divieti; non annuncia neppure una strada senza uscita.`,
      farsiTranslation: `تابلوی «پایان حق تقدم» در جاده‌های شهری و برون‌شهری نشان می‌دهد که جاده دیگر دارای حق تقدم نیست و قواعدی که پیش‌تر در تقاطع‌ها اجرا می‌شد تغییر می‌کند.

پس از تابلو معمولاً قانون عمومی حق تقدم از راست دوباره برقرار می‌شود. اما اگر تابلوی رعایت حق تقدم یا STOP وجود داشته باشد، باید هم به راست و هم به چپ حق تقدم داد. از دست‌دادن حق تقدم نیازمند احتیاط بیشتر است.
...
این تابلو پایان یک الزام، بزرگراه، جادهٔ یک‌طرفه یا دوطرفه، محدودیت سرعت یا همهٔ ممنوعیت‌ها را نشان نمی‌دهد و بن‌بست را نیز اعلام نمی‌کند.`,
    ...
    {
      id: 'topic_3_13',
      title: '3.13 Dare precedenza nei sensi unici alternati',
      italianText: `Il segnale DARE PRECEDENZA NEI SENSI UNICI ALTERNATI si trova su una strada a doppio senso prima di una strettoia nella quale, a causa di lavori, frane o altri ostacoli, rimane spazio sufficiente per il passaggio di una sola fila di veicoli.

Bisogna moderare la velocità e, se necessario, fermarsi per dare la precedenza ai veicoli provenienti dal senso opposto. Il segnale non viene usato prima di qualsiasi restringimento, ma soltanto quando i veicoli dei due sensi non possono passare contemporaneamente.

Se è presente anche un semaforo, si deve dare la precedenza quando il semaforo è spento o giallo lampeggiante; con la luce verde si ha la precedenza. Le indicazioni dell'agente prevalgono sempre sul semaforo e sul segnale.`,
      farsiTranslation: `تابلوی «دادن حق تقدم در عبور نوبتی» در یک جادهٔ دوطرفه و پیش از مسیر باریکی نصب می‌شود که به علت عملیات جاده‌ای، ریزش یا مانع دیگری فقط برای عبور یک ردیف خودرو فضای کافی دارد.

باید سرعت را کاهش داد و در صورت لزوم توقف کرد تا به وسایل نقلیهٔ روبه‌رو حق تقدم داده شود. این تابلو پیش از هر نوع باریک‌شدن جاده استفاده نمی‌شود، بلکه فقط جایی نصب می‌شود که خودروهای دو جهت نتوانند هم‌زمان عبور کنند.
...
اگر چراغ راهنمایی نیز وجود داشته باشد، هنگام خاموش‌بودن چراغ یا زرد چشمک‌زن باید حق تقدم داد؛ با چراغ سبز حق تقدم با ماست. دستور مأمور همیشه بر چراغ و تابلو اولویت دارد.`,
    ...
    {
      id: 'topic_3_14',
      title: '3.14 Diritto di precedenza nei sensi unici alternati',
      italianText: `Il segnale DIRITTO DI PRECEDENZA NEI SENSI UNICI ALTERNATI si trova su una strada a doppio senso prima di una strettoia nella quale i veicoli provenienti dai due sensi non possono passare contemporaneamente.

Chi incontra il segnale ha il diritto di precedenza, ma deve moderare la velocità e verificare che i veicoli provenienti dal senso opposto siano effettivamente disposti a fermarsi. Non è possibile risolvere la situazione limitandosi a tenere bene la destra, perché lo spazio disponibile non consente il transito contemporaneo.

Con un semaforo verde, spento o giallo lampeggiante si ha la precedenza, salvo diversa indicazione dell'agente. Anche con il rosso si deve passare se l'agente lo ordina; viceversa, bisogna fermarsi quando l'agente lo impone.`,
      farsiTranslation: `تابلوی «داشتن حق تقدم در عبور نوبتی» در یک جادهٔ دوطرفه و پیش از مسیر باریکی نصب می‌شود که خودروهای دو جهت نمی‌توانند هم‌زمان از آن عبور کنند.

راننده‌ای که این تابلو را می‌بیند حق تقدم دارد، اما باید سرعت را کاهش دهد و بررسی کند که خودروهای روبه‌رو واقعاً آمادهٔ توقف هستند. صرفاً نزدیک‌شدن به لبهٔ راست مشکل را حل نمی‌کند، زیرا فضای موجود برای عبور هم‌زمان کافی نیست.
...
با چراغ سبز، خاموش یا زرد چشمک‌زن حق تقدم با ماست، مگر آنکه مأمور دستور دیگری بدهد. حتی با چراغ قرمز نیز اگر مأمور دستور عبور دهد باید حرکت کرد؛ برعکس، هر زمان مأمور دستور توقف بدهد باید ایستاد.`,
  ...
  questions: [
    ...
    // Topic 3.2: Fermarsi e dare precedenza (STOP)
    {
      id: 'q_3_2_1',
    ...
    // Topic 3.3: Preavviso di dare precedenza
    {
      id: 'q_3_3_1',
      italianText: 'Il segnale raffigurato è un segnale di prescrizione',
      farsiTranslation: 'تابلوی نشان‌داده‌شده یک تابلوی دستوری است.',
    ...
    // Topic 3.4: Preavviso di fermarsi e dare precedenza
    {
      id: 'q_3_4_1',
    ...
    // Topic 3.6: Intersezione con diritto di precedenza
    {
      id: 'q_3_6_1',
    ...
    // Topic 3.7: Intersezione a T con diritto di precedenza a destra
    {
      id: 'q_3_7_1',
    ...
    // Topic 3.11: Diritto di precedenza
    {
      id: 'q_3_11_1',
    ...
    // Topic 3.12: Fine del diritto di precedenza
    {
      id: 'q_3_12_1',
    ...
    // Topic 3.14: Diritto di precedenza nei sensi unici alternati
    {
      id: 'q_3_14_1',
    ...
    // Missing ministerial questions restored from the 2025 list
    // Topic 3.5: Intersezione con precedenza a destra
    {
      id: 'q_3_5_6',
    ...
    // Topic 3.10: Confluenza a sinistra
    {
      id: 'q_3_10_6',
